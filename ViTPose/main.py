...
class Train(object):
    def __init__(self, sampler, models, conf,
                 training_pkg, trial):
        """
    ...
    def covariance_estimation(self, aux_net, pose_net, pose_encodings, 
                              pred, gt, name, imgs):
        """
        ...
        if name == 'MSE':
            ...
            loss = tic_gradient(means, matrix, out_dim, pose_net, pose_encodings,
    ...
    def _aux_net_inference(self, pose_features, aux_net):
        """
...
class Evaluate(object):
    def __init__(self, sampler, conf,
                 training_pkg, trial):
        """
    ...
    def _get_covariance(self, name, matrix,
                        pose_net, pose_encodings, imgs):
